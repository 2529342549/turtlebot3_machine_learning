    ...
    def __init__(self):
        ...
        try:
            ...
            try:
                ...
                rospy.loginfo("Cannot fin transform between odom and base_link or base_footprint")
...
print("Random initial X and Y coordinater of the Turtlebot are :-")

coord = np.random.uniform(lower,upper,2)
print("Initial X coordinate: ",coord[0])
print("Initial Y coordinate: ",coord[1])

print("Please enter the lower range for generating x and y coordinates for the starting position of turtlebot in degrees")
lower_angle = math.radians(input())

print("Please enter the upper range for generating x and y coordinates for the starting position of turtlebot in degrees")
