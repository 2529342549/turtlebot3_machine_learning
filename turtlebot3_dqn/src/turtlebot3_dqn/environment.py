...
class Env(tk.Tk):
    ...
    def _build_canvas(self):
        ...
        self.triangle5 = canvas.create_image(425, 425, image=self.shapes[1])
        self.triangle6 = canvas.create_image(425, 625, image=self.shapes[1])
        self.triangle7 = canvas.create_image(625, 425, image=self.shapes[1])
        self.triangle8 = canvas.create_image(625, 625, image=self.shapes[1])

        self.circle = canvas.create_image(475, 175, image=self.shapes[2])
